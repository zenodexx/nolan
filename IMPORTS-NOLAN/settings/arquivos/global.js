...
return `*[COTAÇÃO]* - Os dados informados são atualizados 24h por dia:\n–\n• Moeda: *${resposta.name}*\n• Maior valor em 24 horas: *R$ ${Number(resposta.high).toFixed(2)}*\n• Menor valor em 24 horas: *R$ ${Number(resposta.low).toFixed(2)}*\n• Valor da moeda atual: *R$ ${Number(resposta.bid).toFixed(2)}*`
}
...
return `• *${tempo}*, o comando usado não foi encontrado no meu sistema\n• Envie-me *${prefix}menu* para visualizar meus comandos existentes.`
}
...
exports.profileInformation = (pushname, sender, info, putar, putar2, gostosurar, gostosurar2, nivelgador, nivelgado2r, programa, isChVip, conselho, status) => {
...
exports.statusBot = (isAntiImg, isAntiVid, Antidoc, isAntiCtt, Antiloc, isAntilinkgp, isAntiLinkHard, isAntifake, isAntiNotas, isAnticatalogo, isPalavrao, isX9VisuUnica, isWelkom, isAutofigu, isAutorepo, isModobn, isModoAluguel, isLevelingOn, isAntiFlood, isAutodown) => {
return `┏═══♚═══╼✪✮✪╾═══♚═══┓
│╭┈˖⁺˖˚｡⋆🌨️︎｡°✩₊✩°｡🌨️⋆｡˚˖⁺˖┈╮\n┃᨞⁞⚙️⃞⃞⚝ ANTI-IMAGEM: ${isAntiImg ?  '✓' : '✘'}\n┃᨞⁞⚙️⃞⃞⚝ ANTI-VIDEO: ${isAntiVid ?  '✓' : '✘'}\n┃᨞⁞⚙️⃞⃞⚝ ANTI-DOCUMENTO: ${Antidoc ?  '✓' : '✘'}\n┃᨞⁞⚙️⃞⃞⚝ ANTI-CONTATO: ${isAntiCtt ?  '✓' : '✘'}\n┃᨞⁞⚙️⃞⃞⚝ ANTI-LOCALIZAÇÃO: ${Antiloc ?  '✓' : '✘'}\n┃᨞⁞⚙️⃞⃞⚝ ANTI-LINKGP: ${isAntilinkgp ?  '✓' : '✘'}\n┃᨞⁞⚙️⃞⃞⚝ ANTI LINK-HARD: ${isAntiLinkHard ?  '✓' : '✘'}\n┃᨞⁞⚙️⃞⃞⚝ ANTI-FAKE: ${isAntifake ?  '✓' : '✘'}\n┃᨞⁞⚙️⃞⃞⚝ ANTI-NOTAS: ${isAntiNotas ?  '✓' : '✘'}\n┃᨞⁞⚙️⃞⃞⚝ ANTI-CATALOGO: ${isAnticatalogo ?  '✓' : '✘'}\n┃᨞⁞⚙️⃞⃞⚝ ANTI-PALAVRÃO: ${isPalavrao ?  '✓' : '✘'}\n┃᨞⁞⚙️⃞⃞⚝ AUTO-X9VISU: ${isX9VisuUnica ?  '✓' : '✘'}\n┃᨞⁞⚙️⃞⃞⚝ BEM-VINDO: ${isWelkom ?  '✓' : '✘'}\n┃᨞⁞⚙️⃞⃞⚝ AUTO-STICKER: ${isAutofigu ?  '✓' : '✘'}\n┃᨞⁞⚙️⃞⃞⚝ AUTO-RESPOSTA: ${isAutorepo ?  '✓' : '✘'}\n┃᨞⁞⚙️⃞⃞⚝ MODO-BRINCADEIRA: ${isModobn ?  '✓' : '✘'}\n┃᨞⁞⚙️⃞⃞⚝ MODO-ALUGUEL: ${isModoAluguel ?  '✓' : '✘'}\n┃᨞⁞⚙️⃞⃞⚝ MODO-LEVEL: ${isLevelingOn ?  '✓' : '✘'}\n┃᨞⁞⚙️⃞⃞⚝ LIMITE-CARACTERES: ${isAntiFlood ?  '✓' : '✘'}\n┃᨞⁞⚙️⃞⃞⚝ AUTO-DOWNLOAD: ${isAutodown ?  '✓' : '✘'}\n│╰┈˖⁺˖˚｡⋆🌨️︎｡°✩₊✩°｡🌨️⋆｡˚˖⁺˖┈╯
┗═══♚═══╼✪✮✪╾═══♚═══┛`
}
...
return `Meu proprietário "${NickDono}" se encontra ausente no momento.\n- Mensagem: ${tabelin.Motivo_Da_Ausência}`
}

exports.absenceRecordAdmin = (blak) => {
return `*O adminstrador "@${blak.id.split("@")[0]}" se encontra *ausente* nesse momento.\n–\n- Mensagem: ${blak.msg}`
}
