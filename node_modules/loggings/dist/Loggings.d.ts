...
export declare class Loggings {
    ...
    get meta(): {
        ...
        color_fallback: keyof typeof import("./Loggings").LoggingsColors;
        level: import("./Loggings").LoggingsLevel;
        console: boolean;
        logger: (contents: import("./Loggings").LoggingsLoggerContents, type: "error" | "warn" | "info" | "debug") => any;
        controller_title: string;
        controller_color: keyof typeof import("./Loggings").LoggingsColors;
        register: boolean;
